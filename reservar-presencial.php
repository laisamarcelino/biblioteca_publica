  ...
  <body>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 text-center">
            <h1 class="font-weight-bold wow fadeInLeft">Reservar livro</h1>
    ...
    // $sql = "SELECT livros.id_livro, livros.etiqueta, livros.titulo,
    // presencial.id_presencial, presencial.id_livro
    // FROM presencial
        ...
        <div class="container">
          <div class="row justify-content-center border">
            <form style="padding: 50px;" action="" method="post">
              <h5>Digite os dados do usuário para a reserva</h5>
              <br>
              <div class="form-row">
                <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <label>ID do usuário:</label>
                  <input type="text" name="id_codigo" rows="1" class="form-control" value="" placeholder="Verifique em 'consultar usuarios'">
                  <br>
                  <label>Código do usuário:</label>
                  <input type="text" name="identificacao" rows="1" class="form-control" value="" >
                  <br>
                  <label>Nome completo do usuário:</label>
                  <input type="text" name="nome" rows="1" class="form-control" value="" >
                  <br>
    ...
    if (isset($_POST["reservar"]) ){
      ...
      if ($con){
        ...
        print $sql;
        $sql2 = "UPDATE livros SET qtd=0 where id_livro = '$id_livro';";
