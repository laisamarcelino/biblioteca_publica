      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 text-center">
            <h1 class="font-weight-bold wow fadeInLeft">Buscar usuários</h1>
  ...
  if ( isset($_POST['palavra-chave']) ){
    ...
    WHERE identificacao LIKE '%$pesquisa%' OR nome LIKE '%$pesquisa%' OR nascimento LIKE '%$pesquisa%' OR
    cpf LIKE '%$pesquisa%' OR fone_contato LIKE '%$pesquisa%' OR email LIKE '%$pesquisa%' OR
    nome_responsavel LIKE '%$pesquisa%' OR contato_responsavel LIKE '%$pesquisa%' OR contato_responsavel LIKE '%$pesquisa%' OR
    rua LIKE '%$pesquisa%' OR bairro LIKE '%$pesquisa%' OR numero LIKE '%$pesquisa%' OR
    complemento LIKE '%$pesquisa%' OR cep LIKE '%$pesquisa%' ORDER BY nome ASC";

    consulta_usuario_geral($con,$sql);
  } // fechando o isset
