  ...
  <body>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 text-center">
            <h1 class="font-weight-bold wow fadeInLeft">Alterar usuário</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    // usuarios.email, usuarios.fone_contato, usuarios.contato_responsavel, usuarios.rua,
    // usuarios.bairro, usuarios.numero, usuarios.senha, presencial.id_presencial
    // FROM presencial
    // JOIN usuarios
    // ON '$id_codigo' = usuarios.id_codigo
    // limit 1";
    $sql = "SELECT * FROM usuarios WHERE id_codigo='$id_codigo' LIMIT 1";
            ...
            <form action="" method="post">
              <div class="form-row">
                <div class="form-group col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                  <label>Código:</label>
                  <input type="text" name="identificacao" rows="1" class="form-control" value="<?php print "".$livro["identificacao"].""?>">
                  <br>
                  <label>Nome:</label>
                  <input type="text" name="nome" rows="1" class="form-control" value="<?php print "".$livro["nome"].""?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  <label>Nascimento: </label>
                  <input type="text" name="nascimento" rows="1" class="form-control" value="<?php print "".$livro["nascimento"].""?>">
                </div>
                <div class="form-group col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  <label>CPF: </label>
                  <input type="text" name="cpf" rows="1" class="form-control" value="<?php print "".$livro["cpf"].""?>">
                </div>
                <div class="form-group col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  <label>Senha do usuário: </label>
                  <input type="password" name="senha" rows="1" class="form-control" value="<?php //print "".$livro["senha"].""?>" placeholder="Nova senha">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5">
                  <label>Endereço: Logradouro </label>
                  <input type="text" name="rua" rows="1" class="form-control" value="<?php print "".$livro["rua"].""?>">
                </div>
                <div class="form-group col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5">
                  <label>Endereço: bairro </label>
                  <input type="text" name="bairro" rows="1" class="form-control" value="<?php print "".$livro["bairro"].""?>">
                </div>
                <div class="form-group col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                  <label>Endereço: número </label>
                  <input type="text" name="numero" rows="1" class="form-control" value="<?php print "".$livro["numero"].""?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  <label>Telefone para contato: </label>
                  <input type="text" name="fone_contato" rows="1" class="form-control" value="<?php print "".$livro["fone_contato"].""?>">
                </div>
                <div class="form-group col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  <label>Telefone do responsável: </label>
                  <input type="text" name="contato_responsavel" rows="1" class="form-control" value="<?php print "".$livro["contato_responsavel"].""?>">
                </div>

              </div>
              <center>
                <button type='button' class='btn btn-secondary'><a href='pesquisa-usuario.php'>Voltar</a></button>
              ...
              <!-- <center><button type="submit" class="btn btn-primary" style="margin: 20px 0px 20px 0px;">Alterar</button></center> -->
            </form>
          </div>
        </div>
        <?php
    ...
    if (isset($_POST["alterar"]) ){
      if ($con){
        ...
        $sql = "UPDATE usuarios SET identificacao='$identificacao', nome='$nome', nascimento='$nascimento',
        cpf='$cpf', fone_contato=$fone_contato, contato_responsavel='$contato_responsavel',
        rua='$rua', bairro='$bairro', numero='$numero', senha='$senha' WHERE id_codigo = $id_codigo";

        $resultado = mysqli_query($con, $sql);
        if ($resultado){
          print "<script>
          alert('Dado(s) do usuário foi/foram alterado(s)');
      ...
      } // fechando a função verificar_email
    } // fechando a conexao
