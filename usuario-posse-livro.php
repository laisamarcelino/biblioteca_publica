  ...
  <body>
    <header class="section page-header">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-8 text-center">
              <h1 class="font-weight-bold wow fadeInLeft">Buscar usuários em posse de livros</h1>
              ...
              <div class="form-row justify-content-center">
                ...
                <div class="col-12 col-md-12 mb-3 ">
                  <button type="button" class="btn btn-dark float-right" >
                      <a href="multa.php" class="text-muted">Usuários com multa</a>
                  </button>
                </div>
      ...
      if ( isset($_POST['palavra-chave']) ){
        ...
        presencial.data_entrega LIKE '%$pesquisa%' ORDER BY nome ASC";

        consulta_usuario($con,$sql);
      } // fechando o isset
      ...
      <section class="section section-md">
        <div class="container justify-content-center mb-5">
          <div class="row justify-content-left  rounded pr-3 pl-3 pb-5">
            <div class="col d-none d-md-block d-lg-block d-lg-block col-md-4  text-center">
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Informações do livro:</h5>
                  ...
                  <div class="modal-body">
                    ...
                    <p>Etiqueta: </p>
                    <p>Autor (res): </p>
                    <p>Nova data de vencimento: 00/00/0000</p>
                  </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle">Confirmar devolução do livro</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <p>Usuário: print nome do usuário</p>
                  <p>Código do usuário: print código do usuário</p>
                  <p>Título do livro: print título do livro emprestado</p>
                  <p>Etiqueta dio livro: print etiqueta do livro emprestado</p>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                  <button type="submit" class="btn btn-primary">Confirmar</button>
