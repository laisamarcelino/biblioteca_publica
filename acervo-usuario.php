    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8 text-center">
          <h1 class="font-weight-bold wow fadeInLeft">Acervo do usuário</h1>
  ...
  if ( isset($_POST['titulo']) ){
    ...
    $sql = "SELECT * FROM livros WHERE titulo LIKE '%$titulo%' and autor LIKE '%$autor%'
     and editora LIKE '%$editora%' and edicao LIKE '%$edicao%' and isbn LIKE '%$isbn%'";
