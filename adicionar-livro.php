  ...
  <body>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 text-center">
            <h1 class="font-weight-bold wow fadeInLeft">Adicionar livros</h1>
        ...
        <form action="" method="post">
          <div class="form-row">
            <div class="form-group col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
              ...
              <input type="text" name="titulo" rows="1" class="form-control">
            </div>
            <div class="form-group col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
              <label>Etiqueta:</label>
              <input type="text" name="etiqueta" rows="1" class="form-control">
            </div>
          </div>
          <div class="form-group">
            <label>Autor(es):</label>
            <input type="text" name="autor" rows="1" class="form-control">
          </div>
          <div class="form-group">
            <label>Tradutor(es):</label>
            <input type="text" name="tradutor" rows="1" class="form-control">
          </div>
          <div class="form-group">
            <label>Editora: </label>
            <input type="text" name="editora" rows="1" class="form-control">
          </div>
          <div class="form-row">
            <div class="form-group col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
              <label>Edição: </label>
              <input type="number" name="edicao" rows="1" class="form-control">
            </div>
            <div class="form-group col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
              <label>Quantidade de páginas: </label>
              <input type="number" name="numero_pag" rows="1" class="form-control">
            </div>
            <div class="form-group col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
              <label>Ano de publicação: </label>
              <input type="text" name="ano" rows="1" class="form-control">
            </div>
            <div class="form-group col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
              <label>Código ISBN: </label>
              <input type="text" name="isbn" rows="1" class="form-control">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <label>Local de publicação: </label>
              <input type="text" name="local" rows="1" class="form-control">
            </div>
            <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <label>Área do conhecimento: </label>
              <input type="text" name="area" rows="1" class="form-control">
            </div>
          </div>

          <center><input type="submit" name="enviar" class="btn btn-primary" style="margin: 20px 0px 20px 0px;" value="Adicionar"></center>
        </form>
      </div>
    </div>
    ...
    if ( isset($_POST['titulo']) ){
      ...
      if ($con){ //print "a conexão foi feita";
        $sql = "INSERT INTO livros (etiqueta, area_conhecimento, titulo, autor, editora, edicao, isbn, numero_pag, tradutor, data_publicacao, local_publicacao)
        VALUES ('$etiqueta','$area_conhecimento','$titulo','$autor', '$editora','$edicao','$isbn','$numero_pag','$tradutor','$data_publicacao', '$local_publicacao')";
