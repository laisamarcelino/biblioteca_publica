  ...
  <body>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 text-center">
            <h1 class="font-weight-bold wow fadeInLeft">Excluir notificação</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    $sql = "SELECT usuarios.id_codigo, usuarios.nome,
    livros.id_livro, livros.etiqueta, livros.titulo,
    reservar.id_reserva, reservar.data
    FROM reservar
    JOIN usuarios
            ...
            <form style="padding: 50px;" action="" method="post">
              ...
              <div class="form-row">
                <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  ...
                  <input type="text" name="etiqueta" rows="1" class="form-control" value="<?php print "".$livro["data"].""?>" disabled>
                </div>
              </div>
              <button type='button' class='btn btn-secondary'><a href='notificacoes.php'>Voltar</a></button>

              <input type="submit" class="btn btn-primary" style="margin: 20px 0px 20px 0px;" value="Excluir">
  ...
  if (isset($_POST["excluir"]) ){
    ...
    if ($con){
      $sql3 = "UPDATE livros SET qtd=1 WHERE id_livro = '$id_livro';";
      $sql4 = "DELETE FROM reservar WHERE id_codigo = '$id_codigo' AND id_livro = '$id_livro';";

      $resultado3 = mysqli_query($con, $sql3);
      $resultado4 = mysqli_query($con,$sql4);
      if ($resultado3 and $resultado4){
